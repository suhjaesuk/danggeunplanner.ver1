...
public class PlanRequest {
    ...
    @NotNull(message = "종료 시간을 입력해주세요.", groups = ValidationGroups.SecondNotNullGroup.class)
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime endTime;
    @NotNull(message = "계획의 내용을 입력해주세요.", groups = ValidationGroups.ThirdNotNullGroup.class)
